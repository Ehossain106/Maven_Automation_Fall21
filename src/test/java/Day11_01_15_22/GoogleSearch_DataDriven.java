...
public class GoogleSearch_DataDriven extends Reusable_annotations {
    ...
    public void GoogleSearchDataDriven() throws BiffException, IOException, WriteException {
        ...
        Workbook readableFile = Workbook.getWorkbook(new File("src/main/resources/Google_Data.xls"));
        ...
        while( i < rowCount2){
            ...
            Methods.sendKeysMethod(driver,"//*[@name='q']",countries,"Search Field");
            //submit to google search button
            Methods.Submit(driver,"//*[@name='btnK']","Google Search Button");

            //capture the result
            String results = Methods.getTextMethod(driver,"//*[@id='result-stats']","Search Result");
